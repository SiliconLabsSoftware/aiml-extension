...
/*************************************************************************************************/
bool slx_ml_write(const char *name, const void *data, uint32_t length, uint32_t *bytes_written_ptr)
{
    StreamBuffer *stream;
...
/*************************************************************************************************/
bool slx_ml_read(const char *name, void *data, uint32_t length, uint32_t *bytes_read_ptr)
{
    StreamBuffer *stream;
