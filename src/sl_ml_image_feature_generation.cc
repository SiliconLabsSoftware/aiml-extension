...
// RGB565 image requires 2 bytes per pixel , RGB 565 converted to gary in aurducam driver
// Ping-pong buffer requires 2 buffer count
#define SL_ML_CAM_INPUT_IMG_BUFFER_LENGTH     (SL_ML_CAM_IMAGE_HEIGHT * SL_ML_CAM_IMAGE_WIDTH * 2 * 2)
/*******************************************************************************
 ***************************  LOCAL VARIABLES   ********************************
 ******************************************************************************/
...
sl_status_t sl_ml_initialize_arducam_camera()
{
    ...
    cam_config.data_format = ARDUCAM_DATA_FORMAT_GRAYSCALE;
